...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{topo_firewalls2.png}
...
\begin{enumerate}
    \item Communication between PR1 and PR2 was tested and correctly blocked;
    \item Access from the OUT zone to the private zones was denied;
    \item Access from the OUT zone to the DMZ was allowed only for HTTP, HTTPS, SMTP, DNS, and ICMP;
    \item Communication from the private zones to the OUT zone was limited to HTTP, HTTPS, DNS, and ICMP;
    \item Communication from the private zones to the DMZ was allowed only for the specified services and servers.
\end{enumerate}
