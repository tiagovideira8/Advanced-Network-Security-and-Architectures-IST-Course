...
\begin{itemize}
    \item IKEv2 proposal defining AES-CBC-256 encryption, SHA512 integrity, SHA512 PRF, and Diffie-Hellman Group 16;
    \item IKEv2 policy referencing the configured proposal;
    \item IPSec transform sets and profiles associated with IKEv2 tunnel protection;
    \item active IPSec Security Associations and encapsulation parameters.
\end{itemize}

Figures~\ref{fig:ikev2_proposal}, \ref{fig:ikev2_policy}, \ref{fig:ipsec_profile}, and \ref{fig:ipsec_sa} present the verification outputs collected from R1 and R2.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../Images/isakmp messages IKEv2.png}
